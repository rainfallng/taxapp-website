...
const FileTaxes = () => {
  return (
    <div className="text-center bg-white grid md:grid-cols-2 lg:grid-cols-4 gap-[10px] place-items-center py-[71px] max-w-6xl mx-10 md:mx-auto mt-[40px] md:mt-0">
      <div className="w-full md:max-w-[256px] bg-[#ECF1F4] rounded-[15px] px-[32px] py-[52px] place-items-center h-full">
